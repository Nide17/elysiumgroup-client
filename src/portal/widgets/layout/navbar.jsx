  ...
  return (
    <MTNavbar className="p-3">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <IconButton variant="text" size="sm" className="ml-auto text-inherit hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden"
...
Navbar.defaultProps = {
  ...
  action: (
    <a
      href="https://www.elysiumgroup.org"
      target="_blank"
    >
...
Navbar.displayName = "/src/portal/widgets/layout/navbar.jsx";
