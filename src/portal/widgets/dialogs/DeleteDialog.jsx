...
export function DeleteDialog({ dialogTitle, message, gotoUrl, action, btnTitle, altBtnTitle }) {
                            ...
                            <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white
                             text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                <div className="bg-gray-50 px-3 py-3 sm:flex sm:flex-row justify-around sm:px-6">
                                    ...
                                    <button type="button" className="inline-flex w-full justify-center rounded-md 
                                    bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 sm:ml-3 sm:w-auto"
                                        onClick={handleClose}> {altBtnTitle && altBtnTitle}
                                    </button>

                                    {gotoUrl && <button type="button" className="inline-flex w-full justify-center
                                     rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300
                                      hover:bg-gray-500 sm:mt-0 sm:w-auto" onClick={() => window.location.href = gotoUrl} data-autofocus>
                                        {btnTitle && btnTitle}
                                    </button>}

                                    {action && <button type="button" className="inline-flex w-full justify-center rounded-md bg-red-600  px-3 
                                    py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-500 sm:mt-0 sm:w-auto"
                                        onClick={action} data-autofocus>
                                        {btnTitle && btnTitle}
                                    </button>}
                                </div>
                            </DialogPanel>
