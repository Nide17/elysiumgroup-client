...
export function CreateEditDialog({ formData, dialogTitle, btnTitle, altBtnTitle, functionToCall, refresh }) {
    ...
    const handleSubmit = () => {
        const action = currentData._id ?
            functionToCall({ id: currentData._id, data: currentData }) :
            functionToCall(currentData)
            ...
            <Dialog className="relative z-10" onClose={handleClose}>
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <TransitionChild enter="ease-out duration-300" enterFrom="opacity-0 translate-y-4 
                        sm:translate-y-0 sm:scale-95" enterTo="opacity-100 translate-y-0 sm:scale-100"
                             ...
                             text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                        ...
                                        return (
                                            <div key={index} className="flex flex-col gap-4 mb-4">
                                                ...
                                                <input
                                                    ...
                                                    className="border border-blue-500 rounded-md shadow-sm focus:ring-blue-500
                                                     focus:border-blue-500 sm:text-sm h-8 p-2 block w-full"
                                                />
                                            </div>
                                        )
                                    })}
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row justify-around sm:px-6">
                                    <button type="button" onClick={handleClose}
                                        className="inline-flex w-full justify-center rounded-md bg-gray-600 px-3 
                                        py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 sm:ml-3 sm:w-auto"
                                    >
                                    ...
                                    <button type="button" onClick={handleSubmit}
                                        ...
                                        ring-gray-300 hover:bg-blue-500 sm:mt-0 sm:w-auto"
                                    >
                                        {btnTitle && btnTitle}
                                    </button>
                                </div>
