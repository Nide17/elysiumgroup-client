                        ...
                        {isLoading ? (
                            ...
                            <tbody>
                                {services && services.map((
                                    { _id, serviceName, serviceImage, serviceDetail, serviceTitle, createdBy, lastUpdatedBy, createdAt, updatedAt },
                                    key) => {
                                    const className = `py-3 px-2 ${key === services.length - 1 ? "" : "border-b border-blue-gray-50"}`;
                                    const avatarSrc = serviceImage && serviceImage.url ? serviceImage.url : "/img/team-2.jpeg";
