    ...
    if (location.pathname === '/login' || location.pathname === '/signup' || location.pathname === '/forgot-password') { return null }
        ...
        return (
            <footer className="md:mt-auto bg-[#009cde] text-white">
                <div className="px-2 py-4 p-lg-4 flex justify-around md:justify-center align-items-center flex-wrap">

                    <div className="lg:mx-12">
                        <h4 className="text-center font-black mb-3">Get in touch</h4>
                    ...
                    <div className="lg:mx-12 mt-3 lg:mt-0 w-full md:w-auto text-center md:text-start ">
                    ...
                    <div className="lg:mx-12 mt-3 lg:mt-0">
