...
import { Button, Dialog, DialogBody, DialogFooter, NavLink } from "@material-tailwind/react"
...
const DeleteModal = ({ delID, delTitle, deleteFn, deleteFnName }) => {
    ...
    return (
        <>
            ...
            <Dialog centered fullscreen="md" size="md" isOpen={modal} toggle={toggle} style={{ boxShadow: "none" }} className="delete-modal">
                ...
                <DialogBody className="text-center my-4" style={{ backgroundColor: "#f8d7da", fontSize: ".8rem" }}>
                    Delete "<u>{delTitle}</u>" permanently?
                </DialogBody>

                <DialogFooter className="justify-content-around pb-0">
